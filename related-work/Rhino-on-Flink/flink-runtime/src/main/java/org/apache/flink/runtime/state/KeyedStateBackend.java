...
public interface KeyedStateBackend<K>
    ...
    default Map<String, OperatorStatePartition> extractState() throws FlinkException, IOException {
    ...
    default void applyState(String tableName,byte[] bytes) throws FlinkException, IOException {
        throw new UnsupportedOperationException("dispatchOperatorEvent not supported by " + getClass().getName());
    }
}
