...
public abstract class StateTable<K, N, S>
    ...
    public OperatorStatePartition extractState() throws IOException {
        ...
        return new OperatorStatePartition(state, namespaceSerializer, keySerializer, stateSerializer);
    }
    ...
    public void changeKeyGroupRange(int maxparallelism, int parallelism, int newIndex) {
        ...
        KeyGroupRange keyGroupRange = KeyGroupRangeAssignment.computeKeyGroupRangeForOperatorIndex(maxparallelism, parallelism, newIndex);
        int newstart = keyGroupRange.getStartKeyGroup();
        int newend = keyGroupRange.getEndKeyGroup();
        int newSize = keyGroupRange.getNumberOfKeyGroups();
        @SuppressWarnings("unchecked")
        ...
        this.keyContext.setKG(keyGroupRange);
        this.keyGroupedStateMaps = state;
